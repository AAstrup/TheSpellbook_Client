...
public class MessageHandler_ClientCommand_SpellHit : IMessageHandlerCommandClient
{
    ...
    {
        return typeof(Message_ClientCommand_SpellHit);
    }
    ...
    public void Handle(object objData)
    {
        ...
        spellController.Hit(playerController, new Vector3(data.hitDirectionX,0f,data.hitDirectionZ),new Vector3(data.playerPosX,0f, data.playerPosZ),false);
    }
}